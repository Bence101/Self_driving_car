...
// sim settings
let SKIPNGEN = 50; // You can skip even 100 gen, but it could take a while. Try skip only 10-20 gen as it only takes 2-5 min. Warning, if the browser window is not in the foreground, the calculation will stop!
